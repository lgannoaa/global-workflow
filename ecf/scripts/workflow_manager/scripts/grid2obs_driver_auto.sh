...
export NDAYS=$NDAYS      # NDAYS not used, unless locally compute SDATE
export SDATE=$PDYBEG
export EDATE=$PDYEND
...
export COMROTNAM=/gpfs/dell1/nco/ops/com
...
export vsdbsave=$NOSCRUB/$LOGNAME/archive/vsdb_data                ;#place where vsdb database is saved
export opsvsdb=/gpfs/dell2/emc/modeling/noscrub/Fanglin.Yang/stat/vsdb_data  ;#operational model grid-to-obs data base
...
export gdas_prepbufr_arch=/gpfs/dell2/emc/modeling/noscrub/Fanglin.Yang/prepbufr/gdas ;#ops gdas prepbufr archive
export ndasbufr_arch=/gpfs/dell2/emc/modeling/noscrub/Fanglin.Yang/prepbufr/ndas
export nambufr_arch=/gpfs/dell2/emc/modeling/noscrub/Fanglin.Yang/prepbufr/nam
export NWPROD=$vsdbhome/nwprod                              ;#utilities in nwprod
...
export COMROTNCO=$COMROOTp3
export COMROTNAM=$COMROOTp3                                                             
export cputime=10:00:00
export nproc=28
...
#### Lin Gan this is not used by ecflow ecfr low res
#============================
#---produce g2o vsdb database
if [ ${G2OSTATS:-NO} = YES ]; then
#============================
export cyclist="00 12"                      ;#forecast cycles
export expnlist="ecfr"                   ;#experiment names
export expdlist="$NOSCRUB/$LOGNAME/archive"
export hpssdirlist="/NCEPDEV/emc-global/1year/Lin.Gan/WCOSS_DELL_P3/scratch"
...
export DATEST=20200225                      ;#verification starting date
export DATEND=20200226                      ;#verification ending date
...
export mdlist="gfs ecfr"                ;#experiment names, up to 10
export caplist="gfs ecfr"               ;#experiment names to show on maps
export cyclist="00"                        ;#forecast cycles to verify
export vlength=168                         ;#forecast length in hour
export fhoutair="6"                        ;#forecast output frequency in hours for raobs vrfy
export fhoutsfc="3"                        ;#forecast output frequency in hours for sfc vrfy
export DATEST=$SDATE                       ;#verification starting date
export DATEND=$EDATE                       ;#verification ending date
