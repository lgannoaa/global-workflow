...
#export PDY
#export cyc=18
export JOB_LOG_DIR=${JOB_LOG_DIR:-/lfs/h2/emc/ptmp/lin.gan/retro1-v16-ecf/para/com/output/prod/today}
export SOURCE_DIR=${ROTDIR:-/lfs/h2/emc/ptmp/lin.gan/retro1-v16-ecf/para/com/gfs/v16.3}
export ARCH_LIST=${ARCH_LIST:-${SOURCE_DIR}/${RUN}.${PDY}/${cyc}/atmos/archlist}
export HPSS_TARGET_DIR=${ATARDIR:-/NCEPDEV/emc-global/5year/lin.gan/WCOSS2/scratch/retro1-v16-ecf}/${CDATE}
