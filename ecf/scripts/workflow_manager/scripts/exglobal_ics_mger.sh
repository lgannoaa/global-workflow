...
do
  ...
  # Does not run get ic jobs
    ecflow_client --force=complete /para/primary/00/ic_manager/v1.0/gfs/atmos/jgfs_getic
    ecflow_client --force=complete /para/primary/00/ic_manager/v1.0/gfs/atmos/jgfs_init
    break
  else
    if [ $trgfg -eq 0 ]
    then
