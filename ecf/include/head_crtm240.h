...
#### Wire crtm/2.4.0 in for those jobs using GSI
export crtm_ver=2.4.0
export HPC_OPT=/apps/ops/para/libs
export MODULEPATH=$MODULEPATH:/apps/ops/para/libs/modulefiles/compiler/intel/19.1.3.304:/apps/ops/para/libs/modulefiles/mpi/intel/19.1.3.304/cray-mpich/8.1.7
