...
if [[ ! -d gsi.fd ]] ; then
    ...
    git clone --recursive --branch release/gfsda.v16.3.0 https://github.com/NOAA-EMC/GSI.git gsi.fd >> ${topdir}/checkout-gsi.log 2>&1
    cd gsi.fd
...
if [[ ! -d verif-global.fd ]] ; then
    ...
    git clone --recursive --branch verif_global_v2.9.4 https://github.com/NOAA-EMC/EMC_verif-global.git verif-global.fd >> ${topdir}/checkout-verif-global.log 2>&1
    cd ${topdir}
else
